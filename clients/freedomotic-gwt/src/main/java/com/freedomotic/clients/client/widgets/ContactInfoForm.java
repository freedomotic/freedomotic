...
public class ContactInfoForm extends Composite {
    ...
    public ContactInfoForm() {
        ...
        final ContactDatabase.Category[] categories = ContactDatabase.get().queryCategories();
        for (ContactDatabase.Category category : categories) {
        ...
        createButton.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                int categoryIndex = categoryBox.getSelectedIndex();
                ContactDatabase.Category category = categories[categoryIndex];
                contactInfo = new ContactDatabase.ContactInfo(category);
                contactInfo.setFirstName(firstNameBox.getText());
                contactInfo.setLastName(lastNameBox.getText());
                contactInfo.setAddress(addressBox.getText());
                contactInfo.setBirthday(birthdayBox.getValue());
    ...
    public void setContact(ContactDatabase.ContactInfo contact) {
        ...
        if (contact != null) {
            ...
            ContactDatabase.Category category = contact.getCategory();
            ContactDatabase.Category[] categories = ContactDatabase.get().queryCategories();
