...
public class LogFormatter
    ...
    public String getHead(Handler h) {
        return ("<html>\n  " + "<body>\n" + "<h1>Freedomotic Developers Log - " + new Date().toString() + "</h1>"
                ...
                + "<div>You can get a more user/configurator perspective on the project website at <a href=\"http://www.www.freedomotic-platform.com\">http://www.www.freedomotic-platform.com/</a>.</div>"
                + "<div>If you don't know where to start take a look at the <a href=\"http://www.freedomotic-platform.com/content/use-it\">getting started tutorial</a></div><br>"
