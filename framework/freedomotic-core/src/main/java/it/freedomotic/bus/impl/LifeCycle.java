 ...
 * <p>
 * Executes start and stop methods if and only if the {@link BootStatus} is the corresponding one.
 * <p>
 * Implements a fault barrier pattern for start and stop methods signaling exceptions on {@link BootStatus} 
 * 
