...
public class Info {
    ...
    /**
     * This is a little workaround used to retrieve the right freedomotic-core working directory also if it
     * is run from maven. This is needed as we use the git+maven as a SDK for freedomotic.
     * @return a String containing the fixed absolute path to freedomotic-core folder
     */
