 ...
 */
@Deprecated
public abstract class Tool extends Actuator implements BusConsumer {

    public Tool(String pluginName, String manifest) {
        super(pluginName, manifest);
    }

    //a tool don't need to set object behavior
