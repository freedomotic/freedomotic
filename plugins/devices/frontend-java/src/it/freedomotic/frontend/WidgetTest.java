...
/**
 * Only a test to demonstrate how to create custom widgets.
 * This example draws a red vertical bar at the left side of the object icon.
 * Refer to ImageDrawer renderObjects method to enable it.
 * @author enrico
 */
