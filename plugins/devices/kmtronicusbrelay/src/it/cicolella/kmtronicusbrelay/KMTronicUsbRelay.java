 ...
 *
 */
package it.cicolella.kmtronicusbrelay;
...
public class KMTronicUsbRelay extends Protocol {
    ...
    public KMTronicUsbRelay() {
        ...
        super("KMTronicUsbRelay", "/it.cicolella.kmtronicusbrelay/kmtronicusbrelay-manifest.xml");
    ...
    protected void onStart() {
        ...
        loadDevices();
        Freedomotic.logger.info("KMTronicUsbRelay plugin started");
    ...
    protected void onStop() {
        for (FTDevice fTDevice : fTDevices) {
            try {
                ...
                Freedomotic.logger.severe("KMTronicUsbRelay FTD2XX exception " + ex.toString());
            }
            // clear the boards list
            fTDevices = null;
            Freedomotic.logger.info("KMTronicUsbRelay plugin stopped");
