...
package it.cicolella.remotecontroller;
...
public class RemoteController extends Protocol {

    private static final Logger LOG = Logger.getLogger(RemoteController.class.getName());   
    ...
    public RemoteController() {
        super("Remote Controller", "/remotecontroller/remote-controller-manifest.xml");
    ...
    public void onStop() {
        ...
        setDescription(configuration.getStringProperty("description", "Remote Controller stopped"));
    }
    ...
    public void sendEvent(String objectAddress, String eventProperty, String eventValue) {
        ProtocolRead event = new ProtocolRead(this, "remote-controller", objectAddress);
