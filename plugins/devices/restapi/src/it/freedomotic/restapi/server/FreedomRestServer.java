...
public class FreedomRestServer extends Application{
    ...
    public static final String ENVIRONMENT_PATH = "/v1/environment";
    public static final String RESOURCES_PATH = "/v1/resources";
...
/**
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach(ENVIRONMENT_PATH+"/", EnvironmentServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/zones/", ZonesServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/zones/{number}", ZoneServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/objects/", ObjectsServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/objects/{name}", ObjectServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/plugins/", PluginsServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/commands/hardware/", HardwareCommandsServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/commands/user/", UserCommandsServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/triggers/", TriggersServerResource.class);
        router.attach(ENVIRONMENT_PATH+"/resources/{filename}", ImageResourceServerResource.class);                
