 ...
 * @author Enrico
 */
public class VariousSensorsGui extends javax.swing.JFrame {
        ...
        sldLuminosity.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                if (!sldLuminosity.getValueIsAdjusting()) {
                    ...
                    updateDescription("Selected temperature is " + sldTemperature.getValue() + "°C. Selected Luminosity is " + sldLuminosity.getValue() + "%.");
                }
            }
        });
    ...
    private void sldLuminosityStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sldLuminosityStateChanged
