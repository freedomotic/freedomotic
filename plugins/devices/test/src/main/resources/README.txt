...
This package is released under the terms of ${freedomotic.package.license} license by ${freedomotic.package.vendor.name} ${pfreedomotic.ackage.vendor.surname}.
...
You can create a plugin page on our marketplace and upload the compressed file ${name}.zip as it is.
