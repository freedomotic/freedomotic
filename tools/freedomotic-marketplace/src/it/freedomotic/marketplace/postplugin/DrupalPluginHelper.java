 ...
 * @author gpt
 */
public class DrupalPluginHelper {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //creation of the plugin to be post
        MarketPlacePlugin plugin = new MarketPlacePlugin();
        plugin.setTitle("Plugin generated by code");
        plugin.setBody("Bodygenerated by code");
        plugin.setField_category(PluginCategoryEnum.Actuator);
        plugin.addField_os(MarketPlacePlugin.OS_LINUX);
        plugin.addField_os(MarketPlacePlugin.OS_WINDOWS);
        plugin.addTaxonomyWord("test");
        plugin.addTaxonomyWord("plugin");
        plugin.setField_developer("gpulido");
        plugin.setField_status(MarketPlacePlugin.STATUS_PROOF_OF_CONCEPT);
        plugin.setField_description("Description generated by code");
    ...
    public static String parseUid(String loginResponse) {
        try {
            ...
            Logger.getLogger(DrupalPluginHelper.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    ...
    /**
     * Extract the session data from the response obtained after login to the drupal site.
     * This Cookie must be used on every transaction that is going to be realized under
...
//                + "}";
     ...
     * @return The fileId of the new posted file
     * @throws IOException
     */
    public static String postFile(CookieSetting cS, String uid, String pathName, String name) throws IOException {
        ...
        if (resp.getStatus().isSuccess()) {
            try {
                ...
                reader.beginObject();
                String jsonName = reader.nextName();
                if (jsonName.equals("fid")) {
                    fid = reader.nextString();
                }
                reader.close();
