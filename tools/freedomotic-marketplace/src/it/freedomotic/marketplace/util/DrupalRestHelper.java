...
public class DrupalRestHelper {
    ...
    {       
        ...
        URL url;
        try {
            url = new URL(DRUPALPATH+drupalRelativePath);
    ...
    protected static ArrayList<MarketPlacePluginResume> retrieveResumes() {
        ...
        ClientResource cr = new ClientResource(DRUPALPATH+"/rest/node?parameters[type]=plugin");
                ...
                if (name.equals("title")) {
                    ...
                    if (reader.peek() != JsonToken.NULL) {
                        ...
                        while (reader.hasNext()) {
                            ...
                            if (name2.equals("filepath")) {                                
                                pp.setFilePath(DRUPALPATH+reader.nextString());
                            } else {
                                reader.skipValue();
                            }
                        }
                    ...
                    if (reader.peek() != JsonToken.NULL) {
                        ...
                        while (reader.hasNext()) {
                            String name2 = reader.nextName();
                            if (name2.equals("filepath")) {                                
                                pp.setIcon(retrieveImageIcon(reader.nextString()));                                
                            } else {
                                reader.skipValue();
                            }
                        }
